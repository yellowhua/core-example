...
/**
 * <p>boutique_query_multi complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="boutique_query_multi">
 *   &lt;complexContent>
...
@XmlType(name = "boutique_query_multi", propOrder = {
    "guid",
    "interfaceid",
    "queryxml"
})
public class BoutiqueQueryMulti {
