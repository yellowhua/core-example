...
/**
 * <p>microServerFwjkQuery complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="microServerFwjkQuery">
 *   &lt;complexContent>
...
@XmlType(name = "microServerFwjkQuery", propOrder = {
    "guid",
    "applyCode",
    "queryJson"
})
public class MicroServerFwjkQuery {
